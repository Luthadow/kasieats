  ...
  return (
    <section>
      ...
      <div className="panel" style={{ marginBottom: 16 }}>
        <h2>MTHURA Merchant Subscription — R350/month</h2>
        <p style={{ color: '#666', marginBottom: 8 }}>
          Your subscription gives customers access to your store (30-day free trial, then
          R350/month). After expiry you have a 7-day grace period. Customers pay you via EFT and
          upload proof — MTHURA does not process food payments.
        </p>
        {subscription ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
            ...
            {(subscription.status === 'past_due' ||
              ...
              <button className="btn-primary" onClick={paySubscription} disabled={paying}>
                {paying ? 'Processing…' : 'Pay R350 (sandbox)'}
              </button>
            )}
          </div>
        ) : (
